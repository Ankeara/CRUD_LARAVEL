                    ...
                    <div class="col-xl-12 col-xxl-12">
                        <div class="card">
                            <div class="row card-header">
                                <h4 class="card-title">Product edit # {{ $products->id }}</h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <textarea class="form-control" name="description" rows="6" value="" id="comment">{{ old('description', $products->description) }}</textarea>
